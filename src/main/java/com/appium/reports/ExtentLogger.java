/**
 * ExtentLogger class is responsible for printing logs by using ExtentReports listener
 *
 * While running the test suite user want to log some information about the execution in the report.
 * This information will help the user to understand the test step execution flow and any failures during the test suite execution
