...
/**
 * ConfigLoader class is class responsible for reading config property file.
 * User has options for customize framework configurations like ( ExtentReports to be Overridden or not , Screenshots taken when
 * test case failed and attached it on reports and more)
 *
