...
public class ProductTests extends BaseTest {
	...
	@FrameworkAnnotation(severity = {SeverityLevel.Major}, category = { CategoryType.SMOKE, CategoryType.REGRESSION })
	@Test(groups = { "SMOKE", "REGRESSION" })
	public void validateProductOnProductsPage() {
		
		JSONObject jsonObject_ValidUser = 
				new JSONUtils().getJSONObject(TEST_DATA_JSON_FILE).getJSONObject(TEST_DATA_JSON_VALID_USER);
		...
		String expectedProductTitle = StringsManager.getStrings().get(EXPECTED_DATA_KEY_PRODUCT_TITLE);
		...
		String expectedSLBTitle = StringsManager.getStrings().get(EXPECTED_DATA_KEY_PRODUCTS_PAGE_SLB_TITLE);
	...
	public void validateProductOnProductDetailsPage() {
		...
		String expectedSLBDescription = StringsManager.getStrings().get(EXPECTED_DATA_KEY_PRODUCTS_PAGE_SLB_DESCRIPTION);
		VerificationUtils.validate(actualSLBDescription, expectedSLBDescription, "Description for Sauce Labs Backpack");
